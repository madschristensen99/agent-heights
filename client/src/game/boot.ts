...
import { AI_CHAR_TEXTURES, AI_HAIR_STYLES, AI_HAIR_DIRS, AI_HAIR_POSES, hairFrameKey, AI_TILE_TEXTURES, AI_OBJECT_TEXTURES } from "./ai-tiles";
...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    // If a file is missing, loaderror fires and procedural fallback is used.

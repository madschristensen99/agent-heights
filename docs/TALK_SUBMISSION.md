...
**Agent HQ: A Pixel-Art Office Where Every Desk Is a Live Coding Agent**
...
Agent HQ is a retro top-down office game where you hire real AI coding agents — each employee at a desk is a live Claude Agent SDK or OpenAI Codex SDK session that actually reads, writes, and runs code in its own sandboxed workspace folder while you watch from a Phaser game world.

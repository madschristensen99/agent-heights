...
export const MCP_CATALOG: MCPCatalogServer[] = [
  ...
  },
  {
    id: "todoist",
    name: "Todoist",
    summary: "Search, complete, and manage your tasks.",
    description: "Manage tasks and projects in Todoist. Agents can create tasks, complete items, organize projects, and query task history.",
    transport: "remote",
    authType: "oauth",
    isOfficial: true,
  ...
  },
  {
    ...
    description: "Access Expedia's travel platform. Agents can search flights, book hotels, plan trips, and manage travel itineraries.",
    transport: "remote",
    authType: "oauth",
    isOfficial: true,
    category: ["travel", "lifestyle"],
    icon: "https://cdn.simpleicons.org/expedia/white",
    url: "https://mcp.expedia.com/sse",
  },
  {
    id: "booking",
    name: "Booking.com",
    summary: "Find hotels, homes and more.",
    description: "Access Booking.com's accommodation platform. Agents can search hotels, compare prices, read reviews, and make reservations.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["travel", "lifestyle"],
    icon: "https://cdn.simpleicons.org/bookingdotcom/white",
    url: "https://mcp.booking.com/sse",
  },
  {
    id: "tripadvisor",
    name: "Tripadvisor",
    summary: "Find your perfect hotel based on reviews.",
    description: "Access Tripadvisor's review and recommendation platform. Agents can search hotels, read reviews, compare ratings, and find travel recommendations.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["travel", "reviews"],
    icon: "https://cdn.simpleicons.org/tripadvisor/white",
    url: "https://mcp.tripadvisor.com/sse",
  },
  {
    id: "mailchimp",
    name: "Mailchimp",
    summary: "Email marketing and campaigns.",
    description: "Manage Mailchimp email marketing campaigns, audiences, and automations. Agents can create campaigns, manage subscribers, and analyze email performance.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["marketing", "communication"],
    icon: "https://cdn.simpleicons.org/mailchimp/white",
    url: "https://mcp.mailchimp.com/sse",
  },
  {
    id: "intercom",
    name: "Intercom",
  ...
  },
  {
    ...
    description: "Access Brex's corporate card and spend management platform. Agents can query transactions, manage expenses, and analyze corporate spending.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["finance", "business"],
  ...
  },
  {
    ...
    description: "Access Gusto's payroll and HR platform. Agents can query employee data, manage payroll, and access benefits information.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["hr", "business"],
    icon: "https://cdn.simpleicons.org/gusto/white",
    url: "https://mcp.gusto.com/sse",
  },
  {
    id: "quickbooks",
    name: "QuickBooks",
    summary: "Accounting, invoices, business finances.",
    description: "Access QuickBooks accounting platform. Agents can manage invoices, track expenses, query financial reports, and handle business accounting.",
    transport: "remote",
    authType: "oauth",
    isOfficial: true,
    category: ["finance", "accounting"],
    icon: "https://cdn.simpleicons.org/quickbooks/white",
    url: "https://mcp.quickbooks.com/sse",
  },
  {
    id: "xero",
    name: "Xero",
  ...
  },
  {
    ...
    description: "Access Clay's go-to-market data platform. Agents can enrich contacts, prospect companies, and automate GTM workflows with data from multiple providers.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["sales", "business"],
    icon: "https://cdn.simpleicons.org/clay/white",
    url: "https://mcp.clay.com/sse",
  },
  {
    id: "apollo-io",
    name: "Apollo.io",
  ...
  },
  {
    id: "outreach",
    name: "Outreach",
    summary: "Sales engagement and performance.",
    description: "Access Outreach's sales engagement platform. Agents can manage sequences, track touchpoints, and analyze sales team performance.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["sales", "business"],
    icon: "https://cdn.simpleicons.org/outreach/white",
    url: "https://mcp.outreach.io/sse",
  },
  {
    id: "docusing",
    name: "DocuSign",
  ...
  },
  {
    id: "ifttt",
    name: "IFTTT",
    summary: "Connect, control, and automate 1,000+ apps.",
    description: "Access IFTTT's automation platform. Agents can trigger applets, manage connections, and automate workflows across 1,000+ integrated services.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["automation", "productivity"],
    icon: "https://cdn.simpleicons.org/ifttt/white",
    url: "https://mcp.ifttt.com/sse",
  },
  {
    id: "make",
    name: "Make",
  ...
  },
  {
    ...
    description: "Access PlanetScale's serverless database platform. Agents can query databases, manage branches, and analyze schema across Postgres and MySQL.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["database", "backend"],
    icon: "https://cdn.simpleicons.org/planetscale/white",
    url: "https://mcp.planetscale.com/sse",
  },
  {
    id: "mdn",
    name: "MDN Web Docs",
    summary: "Web docs, search, and browser compatibility data.",
    description: "Access Mozilla Developer Network documentation. Agents can search web docs, check browser compatibility, and reference API documentation.",
    transport: "remote",
    authType: "open",
    isOfficial: true,
    category: ["documentation", "development"],
    icon: "https://cdn.simpleicons.org/mdnwebdocs/white",
    url: "https://mcp.mdn.dev/sse",
  },
  {
    id: "microsoft-learn",
  ...
  },
  {
    ...
    description: "Access Yahoo Finance's market data. Agents can query stock prices, retrieve financials, get market news, and analyze price history for any ticker.",
    transport: "remote",
    authType: "open",
    isOfficial: true,
    category: ["finance", "data"],
    icon: "https://cdn.simpleicons.org/yahoofinance/white",
    url: "https://mcp.finance.yahoo.com/sse",
  },
  {
    id: "mercury",
    name: "Mercury",
  ...
  },
  {
    ...
    description: "Access ZipRecruiter's job search platform. Agents can search jobs, manage applications, and query employment opportunities.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["hr", "jobs"],
    icon: "https://cdn.simpleicons.org/ziprecruiter/white",
    url: "https://mcp.ziprecruiter.com/sse",
  },
  {
    id: "survey-monkey",
    name: "SurveyMonkey",
  ...
  },
  {
    ...
    description: "Access Eraser's diagram platform. Agents can create diagrams, manage visual documentation, and update design files.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["design", "development"],
    icon: "https://cdn.simpleicons.org/eraser/white",
    url: "https://mcp.eraser.io/sse",
  },
  {
    id: "godot",
    name: "Godot MCP",
  ...
  },
  {
    id: "minimax",
    name: "MiniMax",
    summary: "Text-to-Speech, image, and video generation APIs.",
    description: "Interact with MiniMax's powerful Text-to-Speech, image, and video generation APIs. Agents can generate media content, create voiceovers, and produce visual assets.",
    transport: "remote",
    authType: "apikey",
    isOfficial: true,
    category: ["ai", "media", "generation"],
    icon: "https://cdn.simpleicons.org/minimax/white",
    url: "https://mcp.minimax.io/sse",
  },
];

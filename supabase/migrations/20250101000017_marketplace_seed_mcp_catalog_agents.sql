...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'docusing,docusign,mcp,Lifestyle',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'courtroom5,courtroom5,mcp,Lifestyle',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'definely,definely,mcp,Lifestyle',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'descrybe-legal-engine,descrybe legal engine,mcp,Lifestyle',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'lawve-ai,lawve ai,mcp,Lifestyle',
    true,
    null,
    null,
    'TypeScript',

...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'notion,notion,mcp,productivity,knowledge',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://linear.app/settings/api',
    ...
    'linear,linear,mcp,productivity,project-management',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'slack,slack,mcp,communication,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Secret Key at https://dashboard.stripe.com/apikeys',
    ...
    'stripe,stripe,mcp,finance,payments',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'figma,figma,mcp,design,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://grafana.com/docs/grafana/latest/administration/service-accounts/',
    ...
    'grafana,grafana,mcp,monitoring,devops',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.mongodb.com/docs/atlas/app-services/authentication/api-key/',
    ...
    'mongodb,mongodb,mcp,database,data',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.firecrawl.dev/app/api-keys',
    ...
    'firecrawl,firecrawl,mcp,web,data',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://docs.n8n.io/advanced-features/api/',
    ...
    'n8n,n8n,mcp,automation,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://vercel.com/account/tokens',
    ...
    'vercel,vercel,mcp,devops,hosting',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://supabase.com/dashboard/account/tokens',
    ...
    'supabase,supabase,mcp,database,backend',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'gitlab,gitlab,mcp,development,git',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://brave.com/search/api/',
    ...
    'brave-search,brave search,mcp,search,web',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Long-Lived Access Token at https://www.home-assistant.io/docs/authentication/',
    ...
    'home-assistant,home assistant,mcp,iot,smart-home',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'asana,asana,mcp,productivity,project-management',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'atlassian,atlassian (jira & confluence),mcp,productivity,project-management,development',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["productivity","project-management","development"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'canva,canva,mcp,design,productivity',
    true,
    null,
    null,
    'TypeScript',
...
',
    ...
    'cloudflare,cloudflare,mcp,cloud,devops,hosting',
    true,
    null,
    null,
    'TypeScript',
...
No authentication required — works immediately.',
    ...
    'deepwiki,deepwiki by devin,mcp,development,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Auth Token at https://sentry.io/settings/auth-tokens/',
    ...
    'sentry,sentry,mcp,monitoring,devops,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Personal API Key at https://us.posthog.com/settings/user-api-keys',
    ...
    'posthog,posthog,mcp,analytics,monitoring',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'shopify,shopify,mcp,commerce,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://developer.zapier.com/api/v1/docs/',
    ...
    'zapier,zapier,mcp,automation,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'zoom,zoom,mcp,communication,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://console.twilio.com/us1/account/keys',
    ...
    'twilio,twilio,mcp,communication,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'paypal,paypal,mcp,finance,payments',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://developers.webflow.com/data/docs/access-tokens',
    ...
    'webflow,webflow,mcp,design,hosting,cms',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://app.netlify.com/user/applications',
    ...
    'netlify,netlify,mcp,devops,hosting',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'airtable,airtable,mcp,productivity,database,data',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://app.clickup.com/settings/apps',
    ...
    'clickup,clickup,mcp,productivity,project-management',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://calendly.com/integrations/api_webhooks',
    ...
    'calendly,calendly,mcp,productivity,scheduling',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'cal-com,cal.com,mcp,productivity,scheduling',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://huggingface.co/settings/tokens',
    ...
    'hugging-face,hugging face,mcp,ai,ml,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://openrouter.ai/keys',
    ...
    'openrouter,openrouter,mcp,ai,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://postman.postman.co/settings/me/api-keys',
    ...
    'postman,postman,mcp,development,api',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'miro,miro,mcp,design,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'lucid,lucid,mcp,design,productivity',
    true,
    null,
    null,
    'TypeScript',
...
No authentication required — works immediately.',
    ...
    'tldraw,tldraw,mcp,design,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.mermaidchart.com/app/settings/api-keys',
    ...
    'mermaid-chart,mermaid chart,mcp,design,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'strava,strava,mcp,fitness,health',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'uber,uber,mcp,transport,lifestyle',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'instacart,instacart,mcp,lifestyle,shopping',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'doordash,doordash,mcp,lifestyle,food',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://developers.intercom.com/docs/references/authentication/',
    ...
    'intercom,intercom,mcp,support,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Token at https://support.pagerduty.com/docs/generating-api-keys',
    ...
    'pagerduty,pagerduty,mcp,devops,monitoring',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://api-docs.incident.io/',
    ...
    'incident-io,incident.io,mcp,devops,monitoring',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://docs.honeycomb.io/manage-api-keys/',
    ...
    'honeycomb,honeycomb,mcp,monitoring,devops',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Service Account at https://mixpanel.com/settings/project#service-accounts',
    ...
    'mixpanel,mixpanel,mcp,analytics,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://amplitude.com/docs/find-amplitude-api-id-and-key',
    ...
    'amplitude,amplitude,mcp,analytics,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://docs.ramp.com/developer-api/v1/overview',
    ...
    'ramp,ramp,mcp,finance,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'xero,xero,mcp,finance,accounting',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://app.apollo.io/settings/integrations/api-key',
    ...
    'apollo-io,apollo.io,mcp,sales,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'docusing,docusign,mcp,legal,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'wordpress,wordpress.com,mcp,cms,content',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://dev.wix.com/docs/go/api/wix-business-management/app-keys',
    ...
    'wix,wix,mcp,cms,hosting,commerce',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.make.com/en/help/api-documentation',
    ...
    'make,make,mcp,automation,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://neon.tech/docs/manage/api-keys',
    ...
    'neon,neon,mcp,database,backend',
    true,
    null,
    null,
    'TypeScript',
...
No authentication required — works immediately.',
    ...
    'microsoft-learn,microsoft learn,mcp,documentation,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://mintlify.com/docs/api',
    ...
    'mintlify,mintlify,mcp,documentation,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.browserbase.com/settings',
    ...
    'browserbase,browserbase,mcp,browser,automation,web',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://parallel.ai/settings',
    ...
    'parallel-search,parallel search,mcp,search,web',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Token at https://docs.mercury.com/reference',
    ...
    'mercury,mercury,mcp,finance,banking',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Token at https://ahrefs.com/api/profile',
    ...
    'ahrefs,ahrefs,mcp,seo,marketing',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.semrush.com/kb/41-api-keys',
    ...
    'semrush,semrush,mcp,seo,marketing',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://www.similarweb.com/corp/api/',
    ...
    'similarweb,similarweb,mcp,analytics,marketing',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'granola,granola,mcp,communication,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://app.fireflies.ai/api/webhooks',
    ...
    'fireflies,fireflies,mcp,communication,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://otter.ai/api',
    ...
    'otter-ai,otter.ai,mcp,communication,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://gamma.app/docs/api',
    ...
    'gamma,gamma,mcp,design,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://dev.workable.com/',
    ...
    'gusto-payroll,workable,mcp,hr,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your Access Token at https://developer.surveymonkey.com/api/v3/',
    ...
    'survey-monkey,surveymonkey,mcp,research,business',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Get your API Key at https://cloudinary.com/documentation/api_keys',
    ...
    'cloudinary,cloudinary,mcp,media,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'railway,railway,mcp,devops,productivity,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'adisinsight,adisinsight,mcp,marketing,analytics,health',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'adobe-experience-manager,adobe experience manager,mcp,marketing,cms',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'adobe-creativity,adobe for creativity,mcp,marketing',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'adobe-journey-optimizer,adobe journey optimizer,mcp,marketing,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'adobe-marketing-agent,adobe marketing agent,mcp,trading,marketing,analytics,ai',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["trading","marketing","analytics","ai"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'aiwyn-tax,aiwyn tax,mcp,finance,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'aurora,aurora,mcp,search,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'autodesk-product-help,autodesk product help,mcp,documentation,commerce',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'aws-marketplace,aws marketplace,mcp,trading,devops',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'bigdata,bigdata.com,mcp,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'blockscout,blockscout,mcp,database,crypto,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'booking,booking.com,mcp,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'brex,brex,mcp,finance,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'cb-insights,cb insights,mcp,analytics',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'chronograph,chronograph,mcp,database,hr',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'circleback,circleback,mcp,communication,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'clarify,clarify,mcp,sales,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'clay,clay,mcp,sales,automation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'clockwise,clockwise,mcp,marketing,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'coindesk,coindesk,mcp,database,crypto',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'consensus,consensus,mcp,search,research',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'contentsquare,contentsquare,mcp,analytics,git,cms',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'control-plane,control plane,mcp,marketing,devops',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'coros,coros,mcp,analytics,database,health,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'coupler-io,coupler.io,mcp,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'courtlistener,courtlistener,mcp,search,legal,research',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'courtroom5,courtroom5,mcp,legal',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'craft,craft,mcp,documentation,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'credit-karma,credit karma,mcp,analytics',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'crossbeam,crossbeam,mcp,analytics,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'crypto-com,crypto.com,mcp,crypto',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'dnb-risk-analytics,d&b risk analytics,mcp,analytics,automation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'datasite,datasite,mcp,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'descrybe-legal-engine,descrybe legal engine,mcp,legal',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'directbooker,directbooker,mcp,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'everlaw,everlaw,mcp,database,search',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'factset,factset,mcp,analytics,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'fever-event-discovery,fever event discovery,mcp,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'fiscal-ai,fiscal.ai,mcp,database,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'gainsight-staircase-ai,gainsight (staircase ai),mcp,analytics,automation,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'gocardless,gocardless,mcp,finance,development',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'godaddy,godaddy,mcp,marketing,search,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'goodnotes,goodnotes,mcp,analytics,documentation,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'bigquery,google cloud bigquery,mcp,marketing,analytics,devops,database',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["marketing","analytics","devops","database"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    'Docusign agent — Agreements, envelopes, signing (OAuth)',
    'docusign,docusign,mcp,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'explorium,explorium,mcp,sales,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'govtribe,govtribe,mcp,database,search',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'grain,grain,mcp,analytics,communication,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'graphos-tools,graphos mcp tools,mcp,search,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'guidepoint,guidepoint,mcp,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'guru,guru,mcp,finance,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'gusto,gusto,mcp,finance,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'harmonic,harmonic,mcp,search,research',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'harvey,harvey,mcp,search,legal,research',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ibisworld,ibisworld,mcp,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ice-data-services,ice data services,mcp,marketing,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'imanage,imanage work,mcp,marketing,documentation,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ironclad-contracts,ironclad contracts,mcp,marketing,search,legal,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ketryx,ketryx,mcp,database,search',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'kindora-funder-discovery,kindora funder discovery,mcp,support',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'kiwi,kiwi.com,mcp,search,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'klaviyo,klaviyo,mcp,trading,marketing,analytics,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'krisp,krisp,mcp,marketing,communication,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'lastminute,lastminute.com,mcp,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'lawve-ai,lawve ai,mcp,legal,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'legal-data-hunter,legal data hunter,mcp,database,search,documentation,legal',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["database","search","documentation","legal"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'legalzoom,legalzoom,mcp,documentation,legal',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'local-falcon,local falcon,mcp,search,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'longbridge,longbridge,mcp,trading,marketing,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'lseg,lseg,mcp,trading,analytics,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'mailchimp,mailchimp,mcp,trading,marketing,communication,ai',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["trading","marketing","communication","ai"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'mailerlite,mailerlite,mcp,trading,marketing,communication,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'malwarebytes,malwarebytes,mcp,communication,security,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'mdn,mdn,mcp,database,search,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'midpage,midpage legal research,mcp,search,legal,commerce,research',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["search","legal","commerce","research"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'monday,monday,mcp,automation,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'monte-carlo,monte carlo,mcp,monitoring,database,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'morningstar,morningstar,mcp,trading,database,search,research',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["trading","database","search","research"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'motherduck,motherduck,mcp,devops,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'motion,motion creative analytics,mcp,marketing,analytics',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'msci,msci,mcp,trading,analytics',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'netdocuments,netdocuments,mcp,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'omni-analytics,omni analytics,mcp,analytics,database,hr,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'open-targets,open targets,mcp,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'orion,orion by gravity,mcp,analytics,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'pendo,pendo,mcp,analytics,commerce',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'pg-aiguide,pg-aiguide,mcp,database,search,documentation,ai',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["database","search","documentation","ai"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'pitchbook,pitchbook,mcp,trading',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'planetscale,planetscale,mcp,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'polar-analytics,polar analytics,mcp,analytics,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'pylon,pylon,mcp,search,support',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'quartr,quartr,mcp,devops,database,search,ai,research',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["devops","database","search","ai","research"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ramp-data,ramp data,mcp,database,search',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'scholar-gateway,scholar gateway,mcp,search,research',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'scite,scite,mcp,search,research',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'signnow,signnow,mcp,documentation',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'solve-intelligence,solve intelligence,mcp,search',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'sp-global,s&p global,mcp,trading,development,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'sprouts,sprouts data intelligence,mcp,sales,marketing,database',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'square,square,mcp,finance,database,search',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'stubhub,stubhub,mcp,trading,support',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'superhuman-mail,superhuman mail,mcp,productivity,communication,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'supermetrics,supermetrics,mcp,trading,marketing,analytics,git,database',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["trading","marketing","analytics","git","database"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'taskrabbit,taskrabbit booking assistance,mcp,productivity,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'third-bridge,third bridge,mcp,analytics',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ticket-tailor,ticket tailor,mcp,support,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'todoist,todoist,mcp,search,productivity',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'sketchup,trimble sketchup,mcp,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'tripadvisor,tripadvisor,mcp,marketing,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'udemy-business,udemy business,mcp,cms',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'unthread,unthread,mcp,marketing,automation,hr,support',
    true,
    null,
    null,
    'TypeScript',
    ...
    '["marketing","automation","hr","support"]',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'verisk-underwriting-intelligence,verisk underwriting intelligence,mcp,analytics',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'verisk-xactrestore,verisk xactrestore,mcp,commerce',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'windsor-ai,windsor.ai,mcp,trading,marketing,database,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    'WordPress.com agent — Secure AI access to manage your WordPress.com sites (OAuth)',
    'wordpress-com,wordpress.com,mcp,ai',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'wyndham-hotels,wyndham hotels and resorts,mcp,travel',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent.',
    ...
    'ziprecruiter,ziprecruiter,mcp,marketing,search,hr',
    true,
    null,
    null,
    'TypeScript',

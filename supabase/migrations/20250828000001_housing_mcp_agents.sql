...
To connect: Get a free API key at https://zillapi.com/signup (100 credits free, no card required). Paste your zk_ key when hiring.',
    ...
    'zillapi,zillow,property,real estate,housing,zestimate,listings,mcp,housing',
    true,
    null,
    null,
    'TypeScript',
...
To connect: Click "Connect via OAuth" when hiring this agent. 300 free credits, no card required.',
    ...
    'stayingapi,accommodation,hotels,airbnb,booking,vrbo,travel,housing,mcp,housing',
    true,
    null,
    null,
    'TypeScript',
...
To start: Just hire the agent. No authentication required — the MCP server provides public read-only data.',
    ...
    'nomad,stays,digital nomad,accommodation,housing,travel,wifi,remote work,mcp,housing',
    true,
    null,
    null,
    'TypeScript',
...
VALUES
  (
    'MCP: Zillapi',
    '{"id":"zillapi","transport":"remote","authType":"apikey","isOfficial":false,"category":["Housing","Real Estate"],"icon":"https://icons.duckduckgo.com/ip3/zillapi.com.ico","url":"https://api.zillapi.com/mcp","keyLabel":"Zillapi API Key","keyPlaceholder":"zk_...","keyHelpUrl":"https://zillapi.com/signup"}',
  ...
  (
    'MCP: StayingAPI',
    '{"id":"stayingapi","transport":"remote","authType":"oauth","isOfficial":false,"category":["Housing","Travel"],"icon":"https://icons.duckduckgo.com/ip3/stayingapi.com.ico","url":"https://mcp.stayingapi.com/mcp"}',
  ...
  (
    'MCP: Nomad Stays',
    '{"id":"nomad-stays","transport":"remote","authType":"open","isOfficial":false,"category":["Housing","Travel","Lifestyle"],"icon":"https://icons.duckduckgo.com/ip3/nomadstays.com.ico","url":"https://mcp.nomadstays.com"}',
